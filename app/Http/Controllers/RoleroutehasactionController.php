...
use App\Model\Roleroutehasaction;
...
class RoleroutehasactionController extends Controller {
     ...
     * @apiVersion 0.1.0
     * @apiName Create Roleroutehasaction
     * @apiGroup Roleroutehasaction
     *
    ...
    public function update(Request $request, $id) {
        ...
        $update = Roleroutehasaction::updateData($attributes, $id);
    ...
    public function index(Request $request) {
        $models = Roleroutehasaction::search($request);
